...
import { IVideoCallState } from "../state.type";
...
export const StartVideoCall = (id: any) => {
  return async (dispatch: AppDispatch, getState: RootState) => {
    dispatch(slice.actions.resetVideoCallQueue(null));
    axios
      .post(
...
export const PushToVideoCallQueue = (call: any) => {
  return async (dispatch: AppDispatch, getState: RootState) => {
...
export const UpdateVideoCallDialog = ({ state }: { state: any }) => {
  return async (dispatch: AppDispatch, getState: RootState) => {
